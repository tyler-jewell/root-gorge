...
abstract class $CropTypeCopyWith<$Res> {
  ...
  $Res call({String id, String name, String description, int color});
}
...
class _$_CropType implements _CropType {
  ...
  @override
  String toString() {
    return 'CropType(id: $id, name: $name, description: $description, color: $color)';
  }
